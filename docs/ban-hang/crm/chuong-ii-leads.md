...
![Mở All Leads](images/lead-process/mo-trang-lam-viec-lead-all-leads.png){ .doc-screenshot-sm }
...
![Giao diện Leads](images/lead-process/chuongI_Muc1_giao-dien-lead.png){ .doc-screenshot-sm }
...
![Lấy Lead VP về TVV](images/lead-process/lay-lead-vp-ve-tvv.png){ .doc-screenshot-sm }

### 2. Liên hệ khách hàng

Từ **My Dashboard** → **XỬ LÝ LEAD MỚI** → click dòng Lead cần xử lý.

![Mở Lead từ dashboard](images/lead-process/mo-lead-tu-dashboard-xu-ly-lead-moi.png){ .doc-screenshot-sm }
...
![Gọi Stringee 1](images/lead-process/goi-lead-tu-dong-stringee1.png){ .doc-screenshot-sm }

![Gọi Stringee 2](images/lead-process/goi-lead-tu-dong-stringee2.png){ .doc-screenshot-sm }
...
![Cập nhật Lead sau liên hệ](images/lead-process/Lead-cap-nhat-thong-tin-sau-lien-he.png){ .doc-screenshot-sm }
...
![Ghi chú trên Lead](images/lead-process/ghi-chu.png){ .doc-screenshot-sm }
...
![Loại Khách hàng](images/lead-process/xac-dinh-loai-khach-hang-khach-hang.png){ .doc-screenshot-sm }
...
![Loại Người đại diện](images/lead-process/xac-dinh-loai-khach-hang-nguoi-dai-dien.png){ .doc-screenshot-sm }
...
![Sơ đồ đánh giá Qualified](images/lead-process/so-do-danh-gia-qualified.png){ .doc-screenshot-sm }

![Đánh giá trên màn hình Lead](images/lead-process/so-do-danh-gia-qualified1.png){ .doc-screenshot-sm }
...
![Lead tình trạng Mới](images/lead-process/lead-invalid-phone-number.png){ .doc-screenshot-sm }
...
![Liên hệ sau lần 1](images/lead-process/tinh-trang-lien-he-sau-lan-1.png){ .doc-screenshot-sm }

### Đã xác minh

Đã gọi/gặp và xác nhận thông tin tư vấn. **Chỉ gắn Edupath Tags sau khi xác minh.**

![Đã xác minh](images/lead-process/tinh-trang-da-xac-minh.png){ .doc-screenshot-sm }
...
![Ngừng chăm sóc sau 3 lần gọi](images/lead-process/tinh-trang-lien-he-sau-lan-3-ngung-cham-soc.png){ .doc-screenshot-sm }
...
![Ngừng chăm sóc sau tư vấn](images/lead-process/tinh-trang-ngung-cham-soc-chua-tu-van.png){ .doc-screenshot-sm }

### Close

Số **không hợp lệ** / dữ liệu rác: sai số, không tín hiệu, `invalid phone number`.

![Close — giao CS kiểm tra SĐT](images/lead-process/tinh-trang-close-gui-cs-kiem-tra-sdt.png){ .doc-screenshot-sm }
...
![CS trả về SĐT sai](images/lead-process/tinh-trang-close-cs-tra-ve-sdt-sai.png){ .doc-screenshot-sm }
...
![CS cập nhật SĐT đúng](images/lead-process/tinh-trang-close-cs-cap-nhat-sdt-dung.png){ .doc-screenshot-sm }
...
![Sơ đồ chấm sao](images/lead-process/danh-gia-sao.png){ .doc-screenshot-sm }
...
![0 sao](images/lead-process/danh-gia-sao0.png){ .doc-screenshot-sm }

![1 sao](images/lead-process/danh-gia-sao1.png){ .doc-screenshot-sm }

![2 sao](images/lead-process/danh-gia-sao2.png){ .doc-screenshot-sm }
...
![Pop-up chuyển cơ hội](images/lead-process/ket-qua-lead.png){ .doc-screenshot-sm }

![Giao diện Cơ hội](images/lead-process/ket-qua-lead1.png){ .doc-screenshot-sm }
...
![Lỗi chuyển cơ hội](images/lead-process/ket-qua-lead-loi.png){ .doc-screenshot-sm }
...
![Tạo Lead TVV](images/lead-process/Lead-moi-tvv.png){ .doc-screenshot-sm }

![Tạo Lead TVV 2](images/lead-process/Lead-moi-tvv1.png){ .doc-screenshot-sm }
...
![Lead trùng](images/lead-process/Lead-moi-tvv2.png){ .doc-screenshot-sm }
