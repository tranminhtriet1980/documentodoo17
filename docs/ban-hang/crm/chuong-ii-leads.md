...
![Mở All Leads](images/lead-process/mo-trang-lam-viec-lead-all-leads.png){ .doc-screenshot-crm }
...
![Giao diện Leads](images/lead-process/chuongI_Muc1_giao-dien-lead.png){ .doc-screenshot-crm }
...
![Lấy Lead VP về TVV](images/lead-process/lay-lead-vp-ve-tvv.png){ .doc-screenshot-crm }

### 2. Liên hệ khách hàng

Từ **My Dashboard** → **XỬ LÝ LEAD MỚI** → click dòng Lead cần xử lý.

![Mở Lead từ dashboard](images/lead-process/mo-lead-tu-dashboard-xu-ly-lead-moi.png){ .doc-screenshot-crm }
...
![Gọi Stringee 1](images/lead-process/goi-lead-tu-dong-stringee1.png){ .doc-screenshot-crm }

![Gọi Stringee 2](images/lead-process/goi-lead-tu-dong-stringee2.png){ .doc-screenshot-crm }
...
![Cập nhật Lead sau liên hệ](images/lead-process/Lead-cap-nhat-thong-tin-sau-lien-he.png){ .doc-screenshot-crm }
...
![Ghi chú trên Lead](images/lead-process/ghi-chu.png){ .doc-screenshot-crm }
...
![Loại Khách hàng](images/lead-process/xac-dinh-loai-khach-hang-khach-hang.png){ .doc-screenshot-crm }
...
![Loại Người đại diện](images/lead-process/xac-dinh-loai-khach-hang-nguoi-dai-dien.png){ .doc-screenshot-crm }
...
![Sơ đồ đánh giá Qualified](images/lead-process/so-do-danh-gia-qualified.png){ .doc-screenshot-crm }

![Đánh giá trên màn hình Lead](images/lead-process/so-do-danh-gia-qualified1.png){ .doc-screenshot-crm }
...
![Lead tình trạng Mới](images/lead-process/lead-invalid-phone-number.png){ .doc-screenshot-crm }
...
![Liên hệ sau lần 1](images/lead-process/tinh-trang-lien-he-sau-lan-1.png){ .doc-screenshot-crm }

### Đã xác minh

Đã gọi/gặp và xác nhận thông tin tư vấn. **Chỉ gắn Edupath Tags sau khi xác minh.**

![Đã xác minh](images/lead-process/tinh-trang-da-xac-minh.png){ .doc-screenshot-crm }
...
![Ngừng chăm sóc sau 3 lần gọi](images/lead-process/tinh-trang-lien-he-sau-lan-3-ngung-cham-soc.png){ .doc-screenshot-crm }
...
![Ngừng chăm sóc sau tư vấn](images/lead-process/tinh-trang-ngung-cham-soc-chua-tu-van.png){ .doc-screenshot-crm }

### Close

Số **không hợp lệ** / dữ liệu rác: sai số, không tín hiệu, `invalid phone number`.

![Close — giao CS kiểm tra SĐT](images/lead-process/tinh-trang-close-gui-cs-kiem-tra-sdt.png){ .doc-screenshot-crm }
...
![CS trả về SĐT sai](images/lead-process/tinh-trang-close-cs-tra-ve-sdt-sai.png){ .doc-screenshot-crm }
...
![CS cập nhật SĐT đúng](images/lead-process/tinh-trang-close-cs-cap-nhat-sdt-dung.png){ .doc-screenshot-crm }
...
![Sơ đồ chấm sao](images/lead-process/danh-gia-sao.png){ .doc-screenshot-crm }
...
![0 sao](images/lead-process/danh-gia-sao0.png){ .doc-screenshot-crm }

![1 sao](images/lead-process/danh-gia-sao1.png){ .doc-screenshot-crm }

![2 sao](images/lead-process/danh-gia-sao2.png){ .doc-screenshot-crm }
...
![Pop-up chuyển cơ hội](images/lead-process/ket-qua-lead.png){ .doc-screenshot-crm }

![Giao diện Cơ hội](images/lead-process/ket-qua-lead1.png){ .doc-screenshot-crm }
...
![Lỗi chuyển cơ hội](images/lead-process/ket-qua-lead-loi.png){ .doc-screenshot-crm }
...
![Tạo Lead TVV](images/lead-process/Lead-moi-tvv.png){ .doc-screenshot-crm }

![Tạo Lead TVV 2](images/lead-process/Lead-moi-tvv1.png){ .doc-screenshot-crm }
...
![Lead trùng](images/lead-process/Lead-moi-tvv2.png){ .doc-screenshot-crm }
